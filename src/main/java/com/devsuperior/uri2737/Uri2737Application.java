...
public class Uri2737Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		List<LawyerMinDTO> resultSQL = list.stream().map(x -> new LawyerMinDTO(x)).collect(Collectors.toList());
...
/*		
		...
		List<LawyerMinDTO> resultJPQL = repository.search2();

		for(LawyerMinDTO obj : resultJPQL) {
			System.out.println(obj);
		}
*/		
	}
